    ...
    return (
        <div className='px-8 lg:px-20 py-30 bg-[#0d314b]' id="projects">
            <div className='my-2 lg:my-5 flex flex-col'>
                <h2 className='self-center text-[#45a29e]/80 text-4xl leading-[50px] lg:text-7xl pb-2 font-extrabold uppercase'>Showcasing</h2>
                <h2 className='self-end text-white text-4xl leading-[50px] lg:text-7xl pt-5 pb-20 lg:pb-28 font-extrabold uppercase text-nowrap'>my works</h2>
            </div>
